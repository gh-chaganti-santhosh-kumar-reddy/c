...
export default function EditProfileForm({ profile, editing, onChange, onImageChange, onCancel, onSave }: EditProfileFormProps) {
  return (
    <form onSubmit={onSave} className="max-w-2xl mx-auto mt-10 bg-white rounded-3xl shadow-2xl p-12 md:p-16 flex flex-col md:flex-row gap-0 items-center md:items-start w-full">
      {/* Left: Profile Image */}

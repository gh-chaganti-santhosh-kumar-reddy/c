...
const EventLivePreview: React.FC<EventLivePreviewProps> = ({ event, forceMobileLayout }) => {
  ...
  return (
    <div className="w-full mx-auto p-0 md:p-4 lg:p-8 bg-white/90 rounded-3xl shadow-xl mt-4 mb-4">
          ...
          <div className={detailsGridClass}>
            <div className="flex items-center gap-3 bg-orange-50/60 border border-orange-100 rounded-xl px-4 py-3 shadow-sm">
              ...
              <div>
                ...
                <div className="text-base font-bold text-gray-800 truncate break-all max-w-xs md:max-w-[220px]" title={event.organizerName}>{event.organizerName}</div>
              </div>
            </div>
            <div className="flex items-center gap-3 bg-indigo-50/60 border border-indigo-100 rounded-xl px-4 py-3 shadow-sm">
              ...
              <div>
                ...
                <div className="text-base font-medium text-gray-800 truncate break-all max-w-xs md:max-w-[220px]" title={event.organizerEmail}>{event.organizerEmail}</div>
              </div>
            </div>

      ...
      >
        ...
        >
          ...
          <div className="w-full flex justify-center mt-8">
            <button
              className="relative px-8 py-3 rounded-xl font-bold text-lg text-white bg-gradient-to-r from-purple-600 via-fuchsia-500 to-purple-700 shadow-lg focus:outline-none focus:ring-4 focus:ring-fuchsia-300 animate-blink"
              style={{
                animation: 'blink 1.2s linear infinite',
                boxShadow: '0 2px 16px 0 #a21caf55',
          ...
          <style jsx global>{`
            @keyframes blink {
              0%, 100% { filter: brightness(1); box-shadow: 0 2px 16px 0 #a21caf55; }
              50% { filter: brightness(1.25); box-shadow: 0 4px 32px 0 #a21caf99; }
            }
          `}</style>
        </div>
      </div>

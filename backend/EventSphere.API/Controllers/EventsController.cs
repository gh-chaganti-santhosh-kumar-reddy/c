...
namespace EventSphere.API.Controllers
{
    ...
    public class EventsController : ControllerBase
    {
        ...
        public async Task<IActionResult> Update(int id, [FromForm] EventSphere.API.Dtos.UpdateEventApiDto apiDto)
        {
            ...
            catch (InvalidOperationException ex) when (ex.Message.Contains("Edit limit exceeded"))
            {
                return StatusCode(429, new { success = false, message = "You have reached the maximum number of edits allowed for this event." });
            }
        }
